...
public class Bean98 {
	...
	private int seven;
	private int eight;
	public Bean98(int first, int secend, int third ,int four,int five,int six,int seven,int eight) {
		super(); 
		int[] arr = {first,secend,third,four,five,six,seven,eight};
	...
	public int hashCode() {
		...
		return (a+b+c+d+e+f+g+h).hashCode();
	}
	@Override
